...
//Video: 38 - How to handle with static json payload
public class Basics2 {
	...
	public static void main(String[] args) throws IOException {
		...
		//convert content of the file to String -> there is some methods which read the content of the file	and convert into bytes
		//convert byte data into string
		
		RestAssured.baseURI = "https://rahulshettyacademy.com";
		String response = given().log().all().queryParam("key", "qaclick123").header("Content-Type", "application/json")
		.body(new String(Files.readAllBytes(Paths.get("C:\\Users\\jyotsana.pandey\\Downloads\\Document\\AddPlace.txt")))).when().post("maps/api/place/add/json")
